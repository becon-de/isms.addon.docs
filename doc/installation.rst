...
* In den Addon-Versionen 3.0 und 3.1 funktioniert das Bearbeiten der Anforderungen in der Kategorie "IT-Grundschutz-Check" nicht, wenn die Mandantendatenbank nicht "idoit_data" heißt. Das Problem wird mit der nächsten Version behoben. Ein Hotfix kann bei Bedarf zur Verfügung gestellt werden.